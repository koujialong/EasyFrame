package com.spy.easyframe.util.AnimPFRecycler;
...
import com.spy.easyframe.util.AnimPFRecycler.listener.OverScrollListener;
import com.spy.easyframe.util.AnimPFRecycler.manager.AnimRFGridLayoutManager;
import com.spy.easyframe.util.AnimPFRecycler.manager.AnimRFLinearLayoutManager;
import com.spy.easyframe.util.AnimPFRecycler.manager.AnimRFStaggeredGridLayoutManager;
...
public class AnimRFRecyclerView extends RecyclerView implements Runnable {
     ...
     * 设置刷新和加载更多数据的监听
     *
     * @param listener {@link com.spy.easyframe.util.AnimPFRecycler.AnimRFRecyclerView.LoadDataListener}
     */
