...
public class BarChart extends CombinedChart{
    ...
    public void setBarData(KLineModel kLineModel){
        //蜡烛数据集合
        ...
        for (int i = 0; i < datas.size(); i++) {
            ...
            lineValues3.add(new Entry(i,Float.parseFloat(list.get(0))));
        }
    ...
    private void showChart(List<CandleEntry> candleValues,List<Entry> lineValues1,List<Entry> lineValues2,
        ...
        //添加辅助线，并且设置辅助线颜色
        sets.add(initLineData(lineValues1, Color.CYAN,true));
        sets.add(initLineData(lineValues2,Color.BLACK,true));
        sets.add(initLineData(lineValues3,Color.BLUE,false));
...
//        leftAxis.setAxisMinValue(averageValue-buffer);
     ...
     * @return:
     */
    private LineDataSet initLineData(List<Entry> yValues, int lineColor,boolean isShow){
        //创建数据集合
